#include "aiboard.h"
#include "ui_aiboard.h"

aiboard::aiboard(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::aiboard)
{
    ui->setupUi(this);
...
void aiboard::loadChessMap(int order, QVector<QVector<int>> chessOrder)
{
    createNewChessBoard();
...
void aiboard::boardDraw(QPainter& painter)
{
...
void aiboard::pointDraw(QPainter& painter)
{
    painter.setBrush(chessLineColor);
    painter.setPen(chessLineColor);
...
void aiboard::pieceDraw(QPainter& painter)
{
    for (int i = 0; i < cellNum + 1; i++)
...
void aiboard::paintEvent(QPaintEvent* e)
{
...
void aiboard::createNewChessBoard()
{
    boardResize();
...
void aiboard::boardCalculation(int maxLen, int minLen, int& maxStart, int& minStart)
{
...
void aiboard::boardCalculation(int sameLen)
{
...
void aiboard::resizeEvent(QResizeEvent* e)
{
    boardResize();
}
